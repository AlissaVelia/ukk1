            ...
            <div class="row">
                ...
                ?>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                <form role="form" action="<?php echo base_url();?>index.php/surat_masuk/ubah_surat_masuk/<?php echo $list->id_surat;?>" method="post" >
                ...
                <div class="form-group has-error">
                        ...
                        <input type="date" class="form-control" id="inputError" name="tgl_terima" value="<?php echo $list->tgl_terima;?>">
                 </div>
                  <div class="form-group has-success">
                         <label class="control-label" for="inputSuccess">Pengirim</label>
                         <input type="text" class="form-control" id="inputSuccess" name="pengirim" value="<?php echo $list->pengirim;?>">
                  </div>
                <div class="form-group has-warning">
