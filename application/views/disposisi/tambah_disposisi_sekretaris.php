  <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <h1 class="page-header"><span class="fa fa-envelope"></span> Disposisi Surat</h1>
...
<?php 
                ...
                ?>
            <form action="<?php echo base_url();?>index.php/surat_masuk/tambah_disposisi_masuk/<?php echo $this->uri->segment(3);?>" method="post">
