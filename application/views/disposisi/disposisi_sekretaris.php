            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <a href="<?php echo base_url();?>index.php/surat_masuk/v_tambah_disposisi/<?php echo $this->uri->segment(3)?>" class="btn btn-primary" class="fa fa-carret"> TAMBAH DIPOSISI</a>
